...
pub const SUBTOPICS: &[Subtopic] = &[
  ...
  Subtopic {
    slug: "tui", label: "终端 UI", blurb: "ratatui 构建全屏交互式终端界面。"
  },
  Subtopic {
    slug: "output", label: "进度与输出", blurb: "进度条、彩色输出与人性化的状态反馈。"
  },
  Subtopic {
    slug: "config",
    label: "配置",
  ...
  Subtopic {
    slug: "distribution", label: "分发", blurb: "交叉编译、静态链接与一键安装脚本。"
  },
];
...
pub const FEATURED_CRATES: &[FeaturedCrate] = &[
  ...
  FeaturedCrate {
    name: "ratatui", blurb: "构建终端用户界面（TUI）", url: "https://ratatui.rs"
  },
  FeaturedCrate {
    name: "indicatif",
    blurb: "进度条与 spinner",
