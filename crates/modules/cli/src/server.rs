...
/// 扫描 `assets/topics/cli/*/index.md`，按日期降序返回文章摘要。
#[server]
pub async fn list_cli_articles() -> Result<Vec<ArticleSummary>, ServerFnError> {
...
#[server]
pub async fn get_cli_article(slug: String) -> Result<String, ServerFnError> {
