...
pub const EPISODES: [Episode; 3] = [
    Episode {
        ...
        desc: "深入探讨神经网络的内部工作机制，为你揭开AI核心原理的面纱。",
        url: "/assets/audio/神经网络大揭秘：从零件到架构，深度解析AI模型核心原理.m4a",
        duration: "24:15",
        date: "2024-01-15",
    },
    Episode {
        ...
        desc: "回顾编程语言的发展历程，探讨现代系统编程范式的演进与平衡。",
        url: "/assets/audio/编程范式螺旋上升：C、OOP到Rust的平衡.m4a",
        duration: "32:40",
        date: "2024-01-08",
    },
    Episode {
        ...
        desc: "实战分享：如何利用Rust的高性能和安全性优势，构建稳定的AI Agent system。",
        url: "/assets/audio/用Rust打造工业级AI智能体.m4a",
        duration: "28:50",
        date: "2024-01-01",
    },
];
                      ...
                      div { class: "sticky top-24",
                          div { class: "relative overflow-hidden rounded-2xl bg-slate-900 shadow-xl border border-[var(--color-border)]",
                              div { class: "relative p-8 md:p-10",
                                  h2 { class: "mt-6 text-2xl md:text-3xl font-bold tracking-tight text-white", "{current_episode().title}" }
                                  p { class: "mt-4 text-base md:text-lg leading-relaxed text-slate-300", "{current_episode().desc}" }
                                  div { class: "mt-8",
                                      audio {
                                          class: "w-full focus:outline-none",
                                          controls: true,
                                          autoplay: true,
                                          src: "{current_episode().url}", // 直接使用字符串路径
                                  ...
                                  rsx! {
                                      button {
                                          ...
                                          class: format_args!(
                                              ...
                                              if current_episode().id == episode.id { "bg-blue-50 dark:bg-blue-900/20 ring-1 ring-blue-200 dark:ring-blue-800" } else { "hover:bg-slate-50 dark:hover:bg-slate-900/50 border border-slate-200 dark:border-slate-800" }
                                          ),
