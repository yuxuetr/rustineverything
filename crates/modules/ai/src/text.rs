...
pub const BOARD_TAGLINE: &str = "用 Rust 做张量计算、模型推理与 LLM 应用：candle、burn 与 ONNX 生态。";
...
pub const SUBTOPICS: &[Subtopic] = &[
    ...
    Subtopic {
        slug: "llm",
        label: "大模型",
        blurb: "本地跑 LLM、量化、KV cache 与流式生成。",
    },
    Subtopic {
        slug: "tokenizers",
        label: "分词",
