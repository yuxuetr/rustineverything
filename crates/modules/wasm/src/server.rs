...
/// 扫描 `assets/topics/wasm/*/index.md`，按日期降序返回文章摘要。
#[server]
pub async fn list_wasm_articles() -> Result<Vec<ArticleSummary>, ServerFnError> {
...
#[server]
pub async fn get_wasm_article(slug: String) -> Result<String, ServerFnError> {
