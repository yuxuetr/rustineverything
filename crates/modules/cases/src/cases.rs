use crate::server::{
    get_case, list_case_categories, list_case_tags, list_cases, Case, CaseSummary,
    TagSummary,
};
use dioxus::prelude::*;
...
fn category_label(c: &str) -> &'static str { match c { "frontend"=>"前端","backend"=>"后端","fullstack"=>"全栈","cli"=>"CLI","embedded"=>"嵌入式","ai"=>"AI","web3"=>"Web3","library"=>"库/框架","tool"=>"工具","desktop"=>"桌面",_=>"其他" } }
fn category_emoji(c: &str) -> &'static str { match c { "frontend"=>"🎨","backend"=>"⚙️","fullstack"=>"🚀","cli"=>"💻","embedded"=>"🔌","ai"=>"🤖","web3"=>"🔗","library"=>"📦","tool"=>"🛠️","desktop"=>"🖥️",_=>"📂" } }
fn category_badge_class(c: &str) -> &'static str { match c { "frontend"=>"bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300","backend"=>"bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300","fullstack"=>"bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300","cli"=>"bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300","embedded"=>"bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300","ai"=>"bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-300","web3"=>"bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300","library"=>"bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300","tool"=>"bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300","desktop"=>"bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300",_=>"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300" } }
fn placeholder_gradient(c: &str) -> &'static str { match c { "frontend"=>"bg-linear-to-br from-slate-800 via-slate-700 to-slate-600 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500","backend"=>"bg-linear-to-br from-slate-900 via-slate-800 to-slate-700 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500","fullstack"=>"bg-linear-to-br from-slate-800 via-slate-700 to-slate-500 dark:from-slate-600 dark:via-slate-500 dark:to-slate-400","cli"=>"bg-linear-to-br from-slate-900 via-slate-700 to-slate-600 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500","embedded"=>"bg-linear-to-br from-slate-800 via-slate-600 to-slate-500 dark:from-slate-600 dark:via-slate-500 dark:to-slate-400","ai"=>"bg-linear-to-br from-slate-900 via-slate-800 to-slate-600 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500","web3"=>"bg-linear-to-br from-slate-800 via-slate-700 to-slate-600 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500","library"=>"bg-linear-to-br from-slate-900 via-slate-700 to-slate-500 dark:from-slate-600 dark:via-slate-500 dark:to-slate-400","tool"=>"bg-linear-to-br from-slate-800 via-slate-600 to-slate-500 dark:from-slate-600 dark:via-slate-500 dark:to-slate-400","desktop"=>"bg-linear-to-br from-slate-900 via-slate-800 to-slate-700 dark:from-slate-700 dark:via-slate-600 dark:to-slate-500",_=>"bg-linear-to-br from-slate-800 via-slate-700 to-slate-600 dark:from-slate-600 dark:via-slate-500 dark:to-slate-400" } }
fn tag_color_class(t: &str) -> &'static str { match t { "axum"=>"bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300","actix"=>"bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300","dioxus"=>"bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300","tokio"=>"bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300","sea-orm"=>"bg-teal-100 dark:bg-teal-900/30 text-teal-700 dark:text-teal-300","wasm"=>"bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300","opensource"=>"bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300","fullstack"=>"bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300","ai"=>"bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-300",_=>"bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300" } }
            ...
            LocalContainer {
                div { class: "flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-8",
                    div {
                        ...
                        h1 { class: "text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white", "Rust 项目案例库" }
                        p { class: "mt-3 max-w-2xl text-slate-600 dark:text-slate-400",
                            "发现真实世界中的 Rust 前端、后端、全栈、AI、Web3、CLI、嵌入式和工具项目。"
                        }
                    }
                    a {
                        href: "{submit_url}",
                        ...
                        Some(list) => rsx! {
                            for category in list.iter() {
                                CategoryChip {
                                    ...
                                    label: category_label(&category.category).to_string(),
                ...
                div { class: "mb-6 flex flex-wrap items-center gap-2",
                    h2 { class: "text-sm font-bold text-slate-900 dark:text-white mr-2", "标签筛选" }
                    match tags {
                        Some(list) if list.is_empty() => rsx! {
                            p { class: "text-sm text-slate-500 dark:text-slate-400", "暂无标签" }
                        },
                        Some(list) => rsx! {
                        ...
                        None => rsx! { p { class: "text-sm text-slate-400", "加载中..." } },
                    }
...
#[component]
fn TagChip(tag: TagSummary, current: Option<String>, on_select: EventHandler<Option<String>>) -> Element {
...
fn CaseCard(case: CaseSummary) -> Element {
    ...
    let cat_label = category_label(&case.category);
        ...
        article { class: "group overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 shadow-sm hover:-translate-y-1 hover:shadow-xl hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300",
            a { href: "{href}", class: "block",
                div { class: "aspect-[16/9] {grad} overflow-hidden relative",
                    ...
                    if case.favorite {
                        div { class: "absolute top-3 right-3 bg-rose-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-lg", "⭐ 精选" }
                    }
                }
            }
            div { class: "p-5",
                ...
                match case {
                    ...
                    Some(None) => rsx! {
                        div { class: "py-20 text-center",
                            h1 { class: "text-2xl font-bold text-slate-900 dark:text-white", "案例未找到" }
                            p { class: "mt-3 text-slate-500 dark:text-slate-400", "案例 \"{slug}\" 不存在或尚未发布。" }
...
fn CaseDetailBody(case: Case) -> Element {
    let category = category_label(&case.category);
    ...
    rsx! {
        div { class: "max-w-5xl mx-auto",
            a { href: "/case", class: "text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline", "← 返回案例库" }
                ...
                div { class: "grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-0",
                    div { class: "p-8 md:p-10",
                        ...
                        div { class: "mt-5 text-sm text-slate-500 dark:text-slate-400",
                            ...
                            span { " · ★ {case.stars} · 收录于 {case.date_added}" }
                        }
                    }
            ...
            div { class: "mt-10 grid grid-cols-1 lg:grid-cols-[1fr_20rem] gap-8",
                article { class: "min-w-0 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/30 p-6 md:p-8",
                    if let Some(readme) = case.readme_md.as_ref() {
                        ...
                        div { class: "text-slate-500 dark:text-slate-400", "该案例暂未提供 README.md。" }
                    }
                }
                aside { class: "lg:sticky lg:top-20 lg:self-start space-y-4",
                    div { class: "rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/40 p-5",
                        h2 { class: "text-sm font-bold text-slate-900 dark:text-white mb-3", "项目信息" }
                        dl { class: "space-y-3 text-sm",
                            div {
                                dt { class: "text-slate-500 dark:text-slate-400", "分类" }
                                dd { class: "font-semibold text-slate-900 dark:text-white", "{category}" }
                            }
                            div {
                                dt { class: "text-slate-500 dark:text-slate-400", "语言" }
