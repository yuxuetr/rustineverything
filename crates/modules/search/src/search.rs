...
fn HitRow(hit: SearchHit) -> Element {
    let badge = match hit.kind.as_str() {
        ...
        "doc" => ("DOC", "bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-300"),
        "topic" => ("TOPIC", "bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300"),
